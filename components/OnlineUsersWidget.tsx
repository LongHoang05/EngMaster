...
export default function OnlineUsersWidget() {
  ...
  return (
    <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-1.5 md:py-2 bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800/30 rounded-xl shadow-sm" title="Số người đang học trực tuyến">
